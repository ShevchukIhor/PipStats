...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get termsBody =>
      'Device Stats (\"Додаток\") надається як є без гарантій. Дані використання залишаються на вашому пристрої. Розробник не несе відповідальності за будь-які збитки. Користуючись Додатком, ви приймаєте ці умови. Повні умови на https://pipboy.skr/terms';
